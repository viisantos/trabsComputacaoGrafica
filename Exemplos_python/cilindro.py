...
#Este exemplo é derivado do tronco de pirâmide. A ideia é desenhar duas bases, e um corpo. Este exemplo pode ser facilmente transformado em um prisma
#Alterando-se o número de vértices.
def cilindro():
    raio = 0.5
    verticesBases = 100
